...
7. THEN search for performance metrics: "architecture pattern performance metrics", "${scale} system performance benchmarks"
8. FINALLY search for implementation details: "implementing [specific pattern] with ${techStackString}"
...
2. EVIDENCE-BASED RECOMMENDATIONS:
   ...
   c. Include quantitative benefits when available (e.g., scalability metrics, latency improvements, throughput numbers)
   d. Provide specific performance benchmarks and capacity metrics where documented
   e. Acknowledge trade-offs with evidence-based reasoning
   f. Consider both immediate needs and long-term evolution
