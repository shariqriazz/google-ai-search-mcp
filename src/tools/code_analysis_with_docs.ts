...
2. EVIDENCE-BASED FEEDBACK:
   ...
   b. Use standardized citation format: [Source: Title - URL] for all major claims
   c. Include direct quotes from official documentation when relevant
   d. Cite specific sections or pages from style guides with version information
   e. Reference exact rules from linting tools commonly used with the language/framework
   f. Link to specific vulnerability patterns from security databases when applicable
...
4. For each finding:
   ...
   e. Include citation using format: [Source: Title - URL]
